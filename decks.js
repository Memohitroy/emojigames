const decks = [
  {
    ...
    author: "MOHIT ROY",
    instructions:
      "Har card par diye emoji ek animated movie ka sanket hain. Aap card ko palat kar ek aur sanket dekh sakte hain. Card ko kheench kar sahi text clue par daalna hai, jo right side mein hoga. Easy mode mein, text clue movie ka naam hoga aur challenging mode mein, text clue movie ke character ya place ka naam hoga. Aap sirf 3 galat matches kar sakte hain.",
    cards: [
      {
        name: "Frozen",
        content: {
...
echo $message;`,
    ...
    },
    {
        ...
        author: "MOHIT ROY",
        instructions: "Har card par diye emoji ek animated movie ka sanket hain. Aap card ko palat kar ek aur sanket dekh sakte hain. Card ko kheench kar sahi text clue par daalna hai, jo right side mein hoga. Easy mode mein, text clue movie ka naam hoga aur challenging mode mein, text clue movie ke character ya place ka naam hoga. Aap sirf 3 galat matches kar sakte hain.",
        cards: [
            {
                name: "Mahatma Gandhi",
                content: {
